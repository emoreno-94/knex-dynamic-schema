...
function createColumn(table, attributes) {
    ...
    if (attributes.type === 'integer' || attributes.type === 'boolean' || attributes.type === 'bigInteger' || attributes.type === 'text'
        || attributes.type === 'date' || attributes.type === 'dateTime' || attributes.type === 'time' || attributes.type === 'timestamps')
    ...
    else if (attributes.type === 'timestamp')
        column = table.timestamp(attributes.columnName).defaultTo(knex.fn.now());
